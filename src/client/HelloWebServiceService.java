 ...
 * 
 */
@WebServiceClient(name = "HelloWebServiceService", targetNamespace = "http://webservice/", wsdlLocation = "http://localhost:456/helloWord?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWEBSERVICESERVICE_QNAME = new QName("http://webservice/", "HelloWebServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:456/helloWord?wsdl");
    ...
    public HelloWebService getHelloWebServicePort() {
        return super.getPort(new QName("http://webservice/", "HelloWebServicePort"), HelloWebService.class);
    }
    ...
    public HelloWebService getHelloWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice/", "HelloWebServicePort"), HelloWebService.class, features);
    }
